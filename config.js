...
module.exports = {
	VERSION: 'v4.4.1', 
    SESSION_ID: process.env.SESSION_ID || '05_16_H_E_R_M_I_T_Q0A4LEH',
    ...
    BOT_NAME: process.env.BOT_NAME || '𝐘𝐚𝐧𝐁𝐨𝐭𝐳',
    ...
    BOT_INFO: process.env.BOT_INFO || '𝐘𝐚𝐧𝐁𝐨𝐭𝐳;𝐀𝐑𝐘𝐀𝐍;6282313360152;https://i.imgur.com/6oRG106.jpeg',
    AUDIO_DATA: process.env.AUDIO_DATA === undefined ? 'ʜᴇʀᴍɪᴛ;ᴀᴅɪᴛʜyᴀɴ;https://i.imgur.com/fj2WE83.jpeg' : process.env.AUDIO_DATA,
    STICKER_DATA: process.env.STICKER_DATA === undefined ? '𝐂𝐫𝐞𝐚𝐭𝐞 𝐁𝐲;𝐘𝐚𝐧' : process.env.STICKER_DATA,
